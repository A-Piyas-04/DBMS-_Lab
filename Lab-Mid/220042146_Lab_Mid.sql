...
-- 3
SELECT C.CUSTOMER_NAME,COUNT(D.ACCOUNT_NUMBER)
FROM CUSTOMER C
...
-- 6
-- IT WAS ASKED TO RETRIEVE CUSTOMERS, SO...
-- I PRINTED ALL CUSTOMER RELATED INFO
...
-- 8
SELECT b.BRANCH_NAME, AVG(AMOUNT) AS AVERAGE_lOAN
FROM BRANCH b
