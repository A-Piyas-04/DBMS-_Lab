...
insert into instructor values ('44444', 'Pias', 'Elec. Eng.', '90000');
...
insert into student values ('66666', 'Ahnaf', 'Physics', '81');
...
SELECT Advisor_Selection.name AS Instructor_Name, COUNT(Advisor.s_ID) AS Student_Count
...
-- task 4
CREATE USER 'student_user' IDENTIFIED BY 'pias46';
CREATE USER 'teacher_user' IDENTIFIED BY 'pias46';
CREATE USER 'hod_user' IDENTIFIED BY 'pias46';
CREATE USER 'admin_user' IDENTIFIED BY 'pias46';

GRANT Student TO 'student_user';
GRANT CourseTeacher TO 'teacher_user';
GRANT HeadOfDepartment TO 'hod_user';
